tasklist-menu-msg = Task list <code>{ $name }</code>.

tasklist-option-create-msg = Enter task. Maximum 32 letters.

tasklist-settings-msg = Configuring task list <code>{ $name }</code>
